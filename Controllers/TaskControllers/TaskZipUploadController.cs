...
namespace Project_Management_System.Controllers.TaskControllers
{
    ...
    [ApiController]
    public class TaskZipUploadController : ControllerBase
    {
        public readonly DataContext _context;

        public TaskZipUploadController(DataContext _context)
        {
            this._context = _context;
        }


        private async Task<string> WriteZip(IFormFile file)
        {
            string fileName = "";
            try
            {
